...
from rl.agents.props_proximal import PROPSProximalAgent
...
def main(options):
    ...
    props = PROPSProximalAgent(model=model, nb_actions=nb_actions, memory=memory, Lmax=Lmax, delta=delta, bound_opts=bound_opts, batch_size=batch_size_props)
    props.compile()
